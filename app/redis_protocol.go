...
// See https://redis.io/docs/reference/protocol-spec/ for more information
...
// String converts Value to a string. If Value cannot be converted, an empty string is returned.
...
// Array converts Value to an array. If Value cannot be converted, an empty array is returned.
